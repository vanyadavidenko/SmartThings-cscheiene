/**
 *  netatmo additional module  Date: 28.06.2018
 *
 ...
 */
metadata {
    definition(name: "Netatmo Additional Module CO2", namespace: "cscheiene", author: "Brian Steere,cscheiene,Vanya Davidenko") {
